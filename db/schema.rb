...
ActiveRecord::Schema.define(:version => 20150519175024) do

  create_table "refinery_employee_skills", :force => true do |t|
  ...
  create_table "refinery_employees_departments", :force => true do |t|
    t.string   "name"
    t.integer  "position"
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
  ...
  create_table "refinery_skills", :force => true do |t|
    t.string   "name"
    t.integer  "position"
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
